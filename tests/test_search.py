...
class MyTestCase(unittest.TestCase):
    ...
    def test_search_and_insert(self):
        ...
        self.index.index()
        self.assertEqual(self.index.search(self.encoder.encode_batch("i have a pen i have an apple"), top_k=1), [1])
        self.assertEqual(self.index.search(self.encoder.encode_batch("numpy python"), top_k=1), [2])
        self.assertEqual(self.index.search(self.encoder.encode_batch("maple story good game"), top_k=1), [4])
